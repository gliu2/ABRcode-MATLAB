function X_csv_new = subtract_singletraceABR_polarities(X_csv)
% Take the average of difference between pairs of single traces in single trace ABR file
% that are alternating in polarity. Purpose is to obtain cochlear
% microphonic signal from differences between rarefaction and condensation stimulus
% inputs.
%
...
% Dependencies: none
% George Liu
% Last edit: 7/10/89 - drop last single trace if odd number
