function [lineOut, fillOut] = steshade(amatrix,alpha,acolor,F,smth, lineWidth)
% usage: steshade(amatrix,alpha,acolor,F,smth)
...
lineOut = plot(F,amean, 'color', acolor,'linewidth', lineWidth); %% change color or linewidth to adjust mean line
if check
    hold off;
end
